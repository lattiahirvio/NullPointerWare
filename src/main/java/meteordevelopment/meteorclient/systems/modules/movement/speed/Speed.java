...
public final class Speed extends Module {
    ...
    public final Setting<Boolean>  grimStrafe = sgGeneral.add(new BoolSetting.Builder()
        .name("Grim strafe")
        .description("")
        .defaultValue(false)
        .visible(() -> speedMode.get() == SpeedModes.Grim)
    ...
    public final Setting<Double> grimStrafeAmount = sgGeneral.add(new DoubleSetting.Builder()
        .name("grim-strafe-amount")
