...
public class Modules extends System<Modules> {
    ...
    private void onKeyBinding(final KeyEvent event) {
        if (event.action == KeyAction.Press && onBinding(true, event.key)) event.cancel();
    }

    @EventHandler(priority = EventPriority.HIGHEST)
    private void onButtonBinding(final MouseButtonEvent event) {
    ...
    @EventHandler
    private void onGameJoined(final GameJoinedEvent event) {
        synchronized (active) {
            for (Module module : modules) {
    ...
    private void initCombat() {
        ...
        add(new AutoWeb());
        add(new BackTrack());
        // broken   add(new BackTrackRise());
        add(new BedAura());
        add(new BetterTickShift());
        add(new BowAimbot());
        add(new BowSpam());
        add(new Burrow());
        add(new Criticals());
    ...
    private void initMisc() {
        ...
        add(new FakeLag());
        add(new GetRotations());
        add(new InventoryTweaks());
        add(new InvManager());
        add(new HideHacks());
        add(new MessageAura());
        add(new NameProtect());
        add(new NoRotationLimit());
        add(new NoSwing());
        add(new Notebot());
        add(new Notifier());
        add(new AntiFreeze());
    ...
    private void initMovement() {
        ...
        add(new Glide());
        add(new GrimFlight());
        add(new GrimPacketFly());
        add(new GrimPhase());
        add(new GUIMove());
        add(new HighJump());
        add(new HitboxExploit());
        add(new Jesus());
        add(new KeyboardRotate());
        add(new LongJump());
        add(new MoveCorrection());
        add(new MoveExploit());
        add(new AutoRobot());
        add(new NoFall());
        add(new NoJumpDelay());
